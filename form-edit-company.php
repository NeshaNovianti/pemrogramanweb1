            ...
            <div class="col-md-8">
                <div class="card text-left">
                    ...
                    <div class="card-body justify-content-center">
                        <form action="ubahcompany.php?id=<?php echo $id ?>" method="POST" enctype="multipart/form-data">
...
<div class="row ">
    <div class="col-md-12 text-center">
        <p class="font-weight-bold">@Copyright by 18111120_NeshaNovianti_TIFRP18CIDB_UASWEB1</p>
    </div>
</div>
